...
public class DeletionOfNode {
    ...
    public static DeletionOfNode insert(DeletionOfNode list, int data) 
    { 
 ...
 // **************DELETION BY KEY************** 
    ...
    public static DeletionOfNode deleteByKey(DeletionOfNode list, int key) 
    { 
        // Store head node 
    ...
    public static void printList(DeletionOfNode list) 
    { 
 ...
 // method to create a Singly linked list with n nodes 
    ...
    { 
        ...
        DeletionOfNode list = new DeletionOfNode(); 
