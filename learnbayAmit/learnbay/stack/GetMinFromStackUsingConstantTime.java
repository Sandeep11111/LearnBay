 ...
 * design-stack-which-returns-minimum-element-constant-time/
 * 
 */
public class GetMinFromStackUsingConstantTime {
	
	private Stack<Integer> s; // main stack to store elements
	private Stack<Integer> aux; // auxiliary stack to store min element
	
	// constructor
	public GetMinFromStackUsingConstantTime() {
		s = new Stack<>();
		aux = new Stack<>();
	}
	...
	public static void main(String[] args) {
		GetMinFromStackUsingConstantTime s = new GetMinFromStackUsingConstantTime();
