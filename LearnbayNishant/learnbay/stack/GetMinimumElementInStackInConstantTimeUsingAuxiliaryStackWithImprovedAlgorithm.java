 ...
 */
public class GetMinimumElementInStackInConstantTimeUsingAuxiliaryStackWithImprovedAlgorithm {
	
	private Stack<Integer> s; // main stack to store elements
	private Stack<Integer> aux;   // auxiliary stack to store min elements
	
	// Constuctor
		public GetMinimumElementInStackInConstantTimeUsingAuxiliaryStackWithImprovedAlgorithm() {
			s = new Stack<>();
			aux = new Stack<>();
		}
	...
	public static void main(String[] args) {
		GetMinimumElementInStackInConstantTimeUsingAuxiliaryStackWithImprovedAlgorithm s = new GetMinimumElementInStackInConstantTimeUsingAuxiliaryStackWithImprovedAlgorithm();
