 ...
 */
public class GetMinimumElementInStackInConstantTimeUsingAuxiliaryStack {
	
	private Stack<Integer> s; // main stack to store elements
	private Stack<Integer> aux;   // auxiliary stack to store min elements
	
	// Constuctor
		public GetMinimumElementInStackInConstantTimeUsingAuxiliaryStack() {
			s = new Stack<>();
			aux = new Stack<>();
		}
	...
	public static void main(String[] args) {
		GetMinimumElementInStackInConstantTimeUsingAuxiliaryStack s = new GetMinimumElementInStackInConstantTimeUsingAuxiliaryStack();
