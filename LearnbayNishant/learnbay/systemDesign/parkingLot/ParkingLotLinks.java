...
public class ParkingLotLinks {
	//coding link-https://github.com/kishanvarma/ParkingLot/blob/master/src/com/kishan/parkinglot/Vehicle.java
	
//https://www.youtube.com/watch?v=DSGsa0pu8-k
	//https://practice.geeksforgeeks.org/problems/how-to-implement-a-parking-system-for-different-category-of-wheeler
...
I have taken a small example with 2 slots per floor and the number of levels are hard coded as n = 2 (As told by the interviewer,which can also be given by the user later, if required). That means,a total of 4 vehicles can be parked. For the fifth vehicle, the UI says PArking FULL.
